...
UNITY_INSTANCING_BUFFER_START(UnityPerMaterial)
    ...
    UNITY_DEFINE_INSTANCED_PROP(int,_MainTexSingleChannelOn)
    UNITY_DEFINE_INSTANCED_PROP(int,_MainTexChannel)
    UNITY_DEFINE_INSTANCED_PROP(int,_MainTexMultiAlpha)
    UNITY_DEFINE_INSTANCED_PROP(int,_BackFaceOn)
    ...
    UNITY_DEFINE_INSTANCED_PROP(int,_MainTexOffset_CustomData_On)
    ...
    UNITY_DEFINE_INSTANCED_PROP(int,_MainTexMaskChannel)
    UNITY_DEFINE_INSTANCED_PROP(int,_MainTexMaskOffsetCustomDataOn)
    ...
    UNITY_DEFINE_INSTANCED_PROP(float,_MainTexUseScreenColor)
    UNITY_DEFINE_INSTANCED_PROP(half2,_MainTexSheet)
    UNITY_DEFINE_INSTANCED_PROP(half,_MainTexSheetAnimSpeed)
    UNITY_DEFINE_INSTANCED_PROP(bool,_MainTexSheetAnimBlendOn)
    // UNITY_DEFINE_INSTANCED_PROP(int,_MainTexSheetPlayOnce)
// ==================================================_VertexWaveOn
    ...
    UNITY_DEFINE_INSTANCED_PROP(int,_VertexWaveDirAlongNormalOn)
    UNITY_DEFINE_INSTANCED_PROP(int,_VertexWaveDirAtten_LocalSpaceOn)
    UNITY_DEFINE_INSTANCED_PROP(int,_VertexWaveAtten_NormalAttenOn)

    UNITY_DEFINE_INSTANCED_PROP(int,_VertexWaveAtten_MaskMapOn)
    UNITY_DEFINE_INSTANCED_PROP(float4,_VertexWaveAtten_MaskMap_ST)
    UNITY_DEFINE_INSTANCED_PROP(int,_VertexWaveAtten_MaskMapOffsetStopOn)
    UNITY_DEFINE_INSTANCED_PROP(int,_VertexWaveAtten_MaskMapChannel)
    UNITY_DEFINE_INSTANCED_PROP(int,_VertexWaveAttenMaskOffsetCustomDataOn)
...
// ==================================================_DistortionOn
    ...
    UNITY_DEFINE_INSTANCED_PROP(int,_DistortionRadialUVOn)
    UNITY_DEFINE_INSTANCED_PROP(float4,_DistortionRadialCenter_LenScale_LenOffset)
    UNITY_DEFINE_INSTANCED_PROP(float,_DistortionRadialRot)
    UNITY_DEFINE_INSTANCED_PROP(int,_DistortionApplyToOffset)
    UNITY_DEFINE_INSTANCED_PROP(int,_DistortionApplyToMainTexMask)
    UNITY_DEFINE_INSTANCED_PROP(int,_DistortionApplyToDissolve)
// ==================================================_DissolveOn
    UNITY_DEFINE_INSTANCED_PROP(float,_DissolveOn)
    UNITY_DEFINE_INSTANCED_PROP(float,_DissolveByVertexColor)
    UNITY_DEFINE_INSTANCED_PROP(int,_DissolveCustomDataOn)
    ...
    UNITY_DEFINE_INSTANCED_PROP(int,_DissolveEdgeWidthCustomDataOn)
...
// ==================================================_OffsetOn
    ...
    UNITY_DEFINE_INSTANCED_PROP(int,_OffsetCustomDataOn)
    ...
    UNITY_DEFINE_INSTANCED_PROP(float4,_OffsetRadialCenter_LenScale_LenOffset)
    UNITY_DEFINE_INSTANCED_PROP(float,_OffsetRadialRot)
// ==================================================_FresnelOn
    UNITY_DEFINE_INSTANCED_PROP(float,_FresnelOn)
    UNITY_DEFINE_INSTANCED_PROP(int,_FresnelColorMode)
...
// ==================================================_EnvReflectOn
    ...
    UNITY_DEFINE_INSTANCED_PROP(int,_EnvMaskUseMainTexMask)
    ...
    UNITY_DEFINE_INSTANCED_PROP(int,_EnvRefractionOn)
...
// ==================================================_MatCapOn
    // UNITY_DEFINE_INSTANCED_PROP(int,_MatCapOn) // to keyword MATCAP_ON
    UNITY_DEFINE_INSTANCED_PROP(float4,_MatCapColor)
    UNITY_DEFINE_INSTANCED_PROP(float,_MatCapIntensity)
    // UNITY_DEFINE_INSTANCED_PROP(int,_MatCapRotateOn) // to keyword MATCAP_ROTATE_ON
    UNITY_DEFINE_INSTANCED_PROP(float,_MatCapAngle)
// ==================================================    _DepthFadingOn
    UNITY_DEFINE_INSTANCED_PROP(int,_DepthFadingOn)
...
// ==================================================_DistortionOn
    ...
    #define _DistortionRadialCenter_LenScale_LenOffset UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial,_DistortionRadialCenter_LenScale_LenOffset)
...
// ==================================================_OffsetOn
    ...
    #define _OffsetRadialCenter_LenScale_LenOffset UNITY_ACCESS_INSTANCED_PROP(UnityPerMaterial,_OffsetRadialCenter_LenScale_LenOffset)
